...
const Chap3 = () => {
  ...
  return (
    <Container className="p-4 content">
      ...
      <p>
        Long term scheduler is also known as a <code>job scheduler.</code> This scheduler regulates the program and select process from the queue and loads them into memory for execution. It also regulates the degree of multi-programing.</p>
      <p>
      ...
      <p>
        Medium-term scheduling is an important part of<code> swapping.</code> It enables you to handle the swapped out-processes. In this scheduler, a running process can become suspended, which makes an I/O request.
      </p>
      <p>
      ...
      <p>
        Short term scheduling is also known as <code>CPU scheduler. </code>The main goal of this scheduler is to boost the system performance according to set criteria. This helps you to select from a group of processes that are ready to execute and allocates CPU to one of them. The dispatcher gives control of the CPU to the process selected by the short term scheduler.
      </p>
     ...
     />
      ...
      <ol type="1">
        <li>
          Non-preemptive: In non-preemptive, the resource can’t be taken from a process until the process completes execution. The switching of resources occurs when the running process terminates and moves to a waiting state.</li>
        <li>	 Preemptive: In preemptive scheduling, the OS allocates the resources to a process for a fixed amount of time. During resource allocation, the process switches from running state to ready state or from waiting state to ready state. This switching occurs as the CPU may give priority to other processes and replace the process with higher priority with the running process.</li>
      </ol>
      ...
      <ul>
        ...
        <li>	CPU/IO burst cycle: Characterizes process execution, which alternates between CPU and I/O activity. CPU times are usually shorter than the time of I/O.</li>
        <li>	The waiting time and Turnaround time are calculated with the help of the following formula.<br />
      ...
      <p>
        Average waiting time= 2+0+11+4/4
        
        =4.25
      </p>
      <p>Average turnaround time=10+5+20+6/4
      ...
      <p>
        In this, jobs are moved into the ready queue when they arrive. Those Processes which have less burst time begins its execution first. When the process with less burst time arrives, then the current process stops execution, and the process having less burst time is allocated with the CPU first.
      </p>
      <h4>
      ...
      <p>
        In the following example, we have 4 processes with process ID P1, P2, P3, and P4. The arrival time and burst time of the processes are given in the following table.
      </p>
      <div class="table-responsive-md">
        <table className="table difftbl">
          <thead>
      ...
      <p>
        The average waiting time will be 0+3+24+26/4
      </p>
      <p>
        12.25ms</p>
      <p>

        As you can see in the GANTT chart that the processes are given CPU time just on the basis of the prioritiy
      ...
      <ul>
        ...
        <li>	Widely used scheduling method in traditional OS.
        </li>
      ...
      <p>– First p1 process is picked from the ready queue and executes for 2 per unit time (time slice = 2).
        If arrival time is not available, it behaves like FCFS with time slice.</p>
      <p>– After P2 is executed for 2 per unit time, P3 is picked up from the ready queue. Since P3 burst
        time is 2 so it will finish the process execution at once.</p>
      <p>– Like P1 and P2 process execution, P4 and p5 will execute 2 time slices and then again it will start
        from P1 same as above.</p>
      <p>
        Waiting time = Turn Around Time – Burst Time</p>
      <p> P1 = 19 – 6 = 13</p>
      <p>P2 = 20 – 5 = 15</p>
      <p>P3 = 6 – 2 = 4</p>
      <p>P4 = 15 – 3 = 12</p>
